...
class Review(models.Model):
    ...
    comment_field = models.CharField(db_column='comment_', max_length=1000)  # Field renamed because it ended with '_'.
    time_field = models.DateTimeField(db_column='time_', blank=True, null=True)  # Field renamed because it ended with '_'.
    c = models.ForeignKey(Course, models.DO_NOTHING, db_column='C_ID', blank=True, null=True)  # Field name made lowercase.
